...
export const Contacts = () => {
  return (
    <form className={styles.wrapper} target='_blank' action='https://formsubmit.co/your@email.com' method='POST'>
      ...
      <div className={styles.textareas}>
        <textarea className={styles.textarea} type='text' name='message' placeholder='Your message' required />
